...
staging_events_copy = (f"""copy staging_events from 's3://udacity-dend/log_data' 
                            credentials 'aws_iam_role=arn:aws:iam::002230111278:role/myRedshiftRole'
...
insert_table_queries = [songplay_table_insert, song_table_insert, artist_table_insert, time_table_insert]
## user_table_insert